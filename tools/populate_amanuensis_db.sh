...
ACCESS_TOKEN=""
USER_ID=""
STATISTICIAN_EMAILS='["YOUR-EMAIL-WITHOUT-USER-ID@gmail.com"]'
...
curl -X POST  -H "Content-Type: application/json" -H "Authorization: Bearer $ACCESS_TOKEN" -d '{"user_id": '"$USER_ID"', "name": "inrg-test-req1", "description": "inrg-test-req description", "filter_set_ids": [1,2], "institution": "UChicago", "statistician_emails": '$STATISTICIAN_EMAILS'}' http://localhost/amanuensis/admin/projects
curl -X POST  -H "Content-Type: application/json" -H "Authorization: Bearer $ACCESS_TOKEN" -d '{"user_id": '"$USER_ID"', "name": "inrg-test-req2", "description": "inrg-test-req description", "filter_set_ids": [3], "institution": "UChicago",  "statistician_emails": '$STATISTICIAN_EMAILS'}' http://localhost/amanuensis/admin/projects
