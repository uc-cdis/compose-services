...
> 🟢 Note: Except for Google Storage buckets, any upload buckets, including local machine storage, are currently not supported out of the box unless they are S3 compliant.
